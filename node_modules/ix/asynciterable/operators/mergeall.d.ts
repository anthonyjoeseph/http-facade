 ...
 */
export declare function mergeAll(concurrent?: number): <TSource>(source: AsyncIterable<AsyncIterable<TSource>>) => FlattenConcurrentAsyncIterable<AsyncIterable<TSource>, TSource>;
